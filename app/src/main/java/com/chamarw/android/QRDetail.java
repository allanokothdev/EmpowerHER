...
public class QRDetail extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Chama chama = (Chama) bundle.getSerializable(Constants.OBJECT);
        ...
        Glide.with(mContext.getApplicationContext()).load(chama.getPic()).placeholder(R.drawable.placeholder).into(circleImageView);
        textView.setText(chama.getTitle());
        subTextView.setText(chama.getGoal());
        getQR(chama.getId());
    }
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(mContext, "com.chamarw.android.fileprovider", file);
        }catch (Exception e){
